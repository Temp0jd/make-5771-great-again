...
const DARK: Palette = Palette {
    ...
    tertiary_label: Color32::from_rgb(151, 163, 185),
...
const ABYSS_DARK: Palette = Palette {
    ...
    tertiary_label: Color32::from_rgb(150, 166, 175),
...
const APRICOT_DARK: Palette = Palette {
    ...
    tertiary_label: Color32::from_rgb(179, 165, 149),
...
const CRIMSON_DARK: Palette = Palette {
    ...
    tertiary_label: Color32::from_rgb(169, 154, 163),
